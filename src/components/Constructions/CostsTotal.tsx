...
const CostsTotal: React.FC = () => {
  return (
    <footer className="bg-brand-gray-100 mb-16 flex flex-wrap items-center justify-center rounded-[20px] p-3 leading-[1.8] md:flex-nowrap md:justify-between lg:leading-[1.6]">
      <strong className="text-brand-orange pr-4 pb-5 pl-1 text-center text-[22px] leading-[26px] font-bold uppercase sm:pb-0 sm:leading-[inherit] lg:text-[26px]">
        Construction costs total
      </strong>
      <div className="flex gap-4">
        <em className="mr-2 max-w-32 overflow-x-auto text-[22px] font-bold text-nowrap text-white uppercase not-italic [scrollbar-width:thin] sm:mr-4 sm:max-w-40 lg:max-w-50 lg:text-[26px]">
          1 380 £
        </em>
        <button
          type="button"
          className="hover:text-brand-orange text-brand-gray-600 relative min-w-[102px] cursor-pointer rounded-xl bg-white p-1.5 text-center text-[15px] font-bold transition sm:min-w-[132px] lg:min-w-[192px]"
        >
          Save
